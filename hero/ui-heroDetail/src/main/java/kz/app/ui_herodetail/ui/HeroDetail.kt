...
import kz.app.hero_domain.maxAttackDmg
import kz.app.hero_domain.minAttackDmg
import kz.app.ui_herodetail.R
...
fun HeroDetail(
    ...
    DefaultScreenUI(
        ...
        onRemoveHeadFromQueue = {
            events.invoke(HeroDetailEvent.OnRemoveHeadFromQueue)
        }
    ) {
        state.hero?.let { hero ->
            LazyColumn(
